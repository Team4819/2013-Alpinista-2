...
<Project Type="Project" LVVersion="12008004">
	<Property Name="varPersistentID:{03C8E796-6801-447A-B8E3-6120BBD78F35}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/LeftUltrasonicValue</Property>
	<Property Name="varPersistentID:{05E041E8-E4E0-4670-B4D0-C34AA7D62B5E}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Refnums/LeftDriveEncoder</Property>
	<Property Name="varPersistentID:{07358BCB-D725-4E02-9FCD-2EBF9D8AEAAC}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Config/IO Port/RightDriveMotor</Property>
	<Property Name="varPersistentID:{08A553D5-14D6-48B8-B934-3D825D9AAC88}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/ScriptTasks/UnnassignedTaskQue</Property>
	...
	<Property Name="varPersistentID:{16B23A13-9BD9-4E8C-8355-73AF3E8D44C5}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Refnums/ArmWinch</Property>
	<Property Name="varPersistentID:{173FC756-3B72-499B-82F6-F16E117A3B9D}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Config/ArmThrottle</Property>
	<Property Name="varPersistentID:{1DABC0AD-21B5-4525-903E-A07F7E4CB06C}" Type="Ref">/My Computer/Globals.lvlib/Refnums/Drive</Property>
	<Property Name="varPersistentID:{1DF73C02-4EB8-4A50-9978-1E049B5B400E}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/ScriptTasks/OtherTask</Property>
	<Property Name="varPersistentID:{283E72E6-1368-4D21-9AAC-18B12BD2463B}" Type="Ref">/My Computer/Globals.lvlib/Config/IO Port/ArmLowlimitDIO</Property>
	<Property Name="varPersistentID:{29FDCC6C-BE87-489D-A52B-D51E201661FC}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Config/IO Port/ArmLowlimitDIO</Property>
	...
	<Property Name="varPersistentID:{3B292A52-FF60-4381-9056-910AC67641FC}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Config/IO Port/LowerRightHookSwitchDIO</Property>
	<Property Name="varPersistentID:{3CF37D3F-2685-44C6-9612-A81664930A9D}" Type="Ref">/My Computer/Globals.lvlib/Config/IO Port/TopHookSwitchDIO</Property>
	<Property Name="varPersistentID:{3D467AB7-08D7-4896-951D-545D9C6B51D7}" Type="Ref">/My Computer/Globals.lvlib/TopHookSwitchValue</Property>
	<Property Name="varPersistentID:{3D7B7EFF-65FD-4D50-BF25-320770ACADA2}" Type="Ref">/My Computer/Globals.lvlib/ScriptTasks/DriveTask</Property>
	<Property Name="varPersistentID:{3E57FCA4-03FD-4A5B-9A4D-38BC0AD27042}" Type="Ref">/My Computer/Globals.lvlib/Refnums/Joystick2</Property>
	<Property Name="varPersistentID:{3F37C8FC-EC89-43B9-A58D-FD2B80B949E2}" Type="Ref">/My Computer/Globals.lvlib/Config/IO Port/LeftUltrasonicPort</Property>
	<Property Name="varPersistentID:{40CA496A-8555-4575-89B6-78C73F2BDDFF}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Refnums/Joystick1</Property>
	<Property Name="varPersistentID:{41C67DCA-6D13-4522-8AA0-B6067527DBF9}" Type="Ref">/My Computer/Globals.lvlib/Config/IO Port/LowerLeftHookSwitchDIO</Property>
	<Property Name="varPersistentID:{442EF02C-1434-42C9-AA02-CF4041D922AB}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Config/Controls/XDriveJoystickAxis</Property>
	<Property Name="varPersistentID:{45520201-11ED-4C32-AF3F-7709BDF6B2EF}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Config/IO Port/LeftUltrasonicPort</Property>
	<Property Name="varPersistentID:{47ECD4DE-F10F-4CBD-B4AB-5DFC851F1A4F}" Type="Ref">/My Computer/Globals.lvlib/XPower</Property>
	<Property Name="varPersistentID:{495B5085-0649-47D0-AD5A-671B525D693B}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/LowerLeftHookSwitchValue</Property>
	<Property Name="varPersistentID:{4CB36351-0693-44D8-AB21-D21152FB846D}" Type="Ref">/My Computer/Globals.lvlib/Refnums/LeftUltrasonic</Property>
	<Property Name="varPersistentID:{4E2C9DCF-B8EA-4460-A060-D9B7B435018A}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/YPower</Property>
	<Property Name="varPersistentID:{537B4C73-0841-4D5E-AD8C-966024FD8D64}" Type="Ref">/My Computer/Globals.lvlib/ArmPower</Property>
	<Property Name="varPersistentID:{53C48528-DEFF-4964-B797-50746C6144B9}" Type="Ref">/My Computer/Globals.lvlib/ScriptTasks/OtherTask</Property>
	<Property Name="varPersistentID:{5508096E-51AD-4213-8725-DBD4924C7939}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/LeftDriveEncoderValue</Property>
	<Property Name="varPersistentID:{5792720A-7276-4F9B-9893-AFEFA0F3FAB0}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Config/Controls/ArmWinchJoystickAxis</Property>
	<Property Name="varPersistentID:{5948255B-E1E8-4471-BEB0-B58ACCF679D4}" Type="Ref">/My Computer/Globals.lvlib/Refnums/Joystick1</Property>
	<Property Name="varPersistentID:{5B6FE3DC-6C78-4893-B28E-E96C766A62A7}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Refnums/Joystick2</Property>
	<Property Name="varPersistentID:{5C8ABA91-5A52-4222-877D-A16A3507B24D}" Type="Ref">/My Computer/Globals.lvlib/Config/UltrasonicScalingFactor</Property>
	<Property Name="varPersistentID:{5D1B28B4-2E19-4F0A-9093-CB42AD1C35A7}" Type="Ref">/My Computer/Globals.lvlib/ArmLowLimitValue</Property>
	<Property Name="varPersistentID:{5E93BFC7-BF59-4E01-A8FF-6A7DEBCCD954}" Type="Ref">/My Computer/Globals.lvlib/Config/IO Port/LeftDriveMotor</Property>
	<Property Name="varPersistentID:{5EF81B7F-82B2-4AB5-91FA-D13703D537BD}" Type="Ref">/My Computer/Globals.lvlib/ScriptTimer</Property>
	...
	<Property Name="varPersistentID:{7087407B-052C-43DA-8058-534E9B19D579}" Type="Ref">/My Computer/Globals.lvlib/Config/Controls/ArmWinchJoystickAxis</Property>
	<Property Name="varPersistentID:{71B40276-4049-4124-87DF-804BB1F35EF5}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Config/IO Port/TopHookSwitchDIO</Property>
	<Property Name="varPersistentID:{71C8C0FD-4491-4A8D-891E-ED9EDAFFCAF3}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/ControlArmInput</Property>
	...
	<Property Name="varPersistentID:{85631263-0BDA-485F-958D-B4EE2A94DBBA}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Refnums/ArmEncoder</Property>
	<Property Name="varPersistentID:{87EC7E02-C085-4BAC-B06F-CC92ED69A4DF}" Type="Ref">/My Computer/Globals.lvlib/SimUltrasonicValue</Property>
	...
	<Property Name="varPersistentID:{B6EA8724-1064-4231-85F1-4C248D769642}" Type="Ref">/My Computer/Globals.lvlib/Refnums/RightUltrasonic</Property>
	<Property Name="varPersistentID:{B9B06A64-7E61-48DC-B885-2A828447D589}" Type="Ref">/My Computer/Globals.lvlib/Config/IO Port/ArmEncoderPort</Property>
	<Property Name="varPersistentID:{BC46330F-1B2F-49DC-B66A-0194DB60768E}" Type="Ref">/My Computer/Globals.lvlib/Refnums/LowerLeftHookSwitch</Property>
	<Property Name="varPersistentID:{BD7C3E2F-93C5-4171-82F2-825B8ED47076}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/ScriptTimer</Property>
	<Property Name="varPersistentID:{C06A58F3-F1C4-4A51-8C12-FFD590D616E0}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/ArmLowLimitValue</Property>
	<Property Name="varPersistentID:{C5709CB0-E7B6-4B3E-9DFC-BB982797805A}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/XPower</Property>
	<Property Name="varPersistentID:{C6435683-2F5D-4C51-884F-DDF2830F5690}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Refnums/TopHookSwitch</Property>
	<Property Name="varPersistentID:{C72E488B-9A82-400F-9BC6-733B04E4FDA1}" Type="Ref">/My Computer/Globals.lvlib/Refnums/ArmWinch</Property>
	...
	<Property Name="varPersistentID:{DADBD415-EFBD-4E90-B68A-514751B71214}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Refnums/Drive</Property>
	<Property Name="varPersistentID:{DF2EE306-7AF4-4F4B-A027-B36861DECA3C}" Type="Ref">/My Computer/Globals.lvlib/LeftDriveEncoderValue</Property>
	<Property Name="varPersistentID:{E0BD1AF2-36C4-4B48-9FE5-7A9B7C999882}" Type="Ref">/My Computer/Globals.lvlib/Config/IO Port/RightUltrasonicPort</Property>
	<Property Name="varPersistentID:{E13D664B-D837-451F-BF40-FA639B161125}" Type="Ref">/My Computer/Globals.lvlib/LowerLeftHookSwitchValue</Property>
	<Property Name="varPersistentID:{E23E52B4-AD78-4E8C-99E4-C5E76D25F3F5}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Config/IO Port/RightUltrasonicPort</Property>
	<Property Name="varPersistentID:{E24EC861-BFB8-45AA-8BF8-17742176B97B}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/ScriptTasks/DriveTask</Property>
	<Property Name="varPersistentID:{E2710E6C-2193-4FBC-9839-19546A5A8245}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/RightDriveEncoderValue</Property>
	<Property Name="varPersistentID:{E428F086-3DDB-4700-BB1F-473E9127B9DE}" Type="Ref">/My Computer/Globals.lvlib/Config/YThrottle</Property>
	<Property Name="varPersistentID:{E4BC6CC6-80B5-4388-A54D-39E0378E3CD8}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Config/IO Port/LeftDriveMotor</Property>
	<Property Name="varPersistentID:{E5555E11-9905-46D1-9D61-EFFD709D781D}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Refnums/LowerRightHookSwitch</Property>
...
KeepAliveTimeout 60
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="RTExe_localDestPath" Type="Path">/C/Users/Christian/Documents/LabVIEW Data/2013 Alpinista 2/Builds</Property>
